...
- [x] Define the seventeen canonical curated scenarios.
...
- [ ] Add a post-outage system-logs-warning replay when system logs need review without a low-uptime panic.
