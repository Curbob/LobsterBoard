...
- The latest QA proof JSON is saved to `artifacts/qa/homebase-latest.json` with git metadata, acceptance gates, replay contracts, screenshot metadata, and persisted evidence counts.
