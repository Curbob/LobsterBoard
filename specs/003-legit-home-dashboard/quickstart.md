...
- Rendered first-screen assertions confirm loaded copy, house-state ordering, grouped recent changes, local links below recent changes, no horizontal overflow, and no raw/scaffold labels in the visible viewport.
