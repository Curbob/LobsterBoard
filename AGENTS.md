...
Use `npm run check:homebase` as the preferred Homebase release gate. It includes lint/tests, replay fixtures, local Homebase route smokes, first-screen copy blacklist checks, rendered first-screen assertions, phone/iPad/desktop screenshot capture, and public Funnel auth smoke when reachable.
